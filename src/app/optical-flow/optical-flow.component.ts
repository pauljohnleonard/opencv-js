...
@Component({
    selector: 'app-optical-flow',
    templateUrl: './optical-flow.component.html',
    styleUrls: ['./optical-flow.component.css']
})
export class OpticalFlowComponent implements OnInit {
